...
final class audience_test extends advanced_testcase {
    ...
    public static function get_sql_filter_provider(): array {
        return [
            [audience::ANY_VALUE, null, ['user1', 'user2', 'admin', 'guest']],
            [audience::EQUAL_TO, 'audience1', ['user1']],
            [audience::EQUAL_TO, 'audience2', ['user2']],
            [audience::NOT_EQUAL_TO, 'audience1', ['user2', 'admin', 'guest']],
            [audience::NOT_EQUAL_TO, 'audience2', ['user1', 'admin', 'guest']],
        ];
    }
