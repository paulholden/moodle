...
class qtype_essay_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $mingrp[] = $mform->createElement('text', 'minwordlimit', $strminwordlimit, $wordlimitoptions);
        ...
        $maxgrp[] = $mform->createElement('text', 'maxwordlimit', $strmaxwordlimit, $wordlimitoptions);
