...
final class plugin_manager_test extends \advanced_testcase {
    ...
    public function test_plugin_manager_deprecated_subplugintype(): void {
        ...
        $this->assertEquals('Fake full featured plugin / Full Sub Fakes', $pluginman->plugintype_name_plural('fulldeprecatedsubtype'));
    }
    ...
    public function test_plugin_manager_deleted_subplugintype(): void {
        ...
        $this->assertEquals('Fake full featured plugin / [[subplugintype_fulldeletedsubtype]]', $pluginman->plugintype_name('fulldeletedsubtype'));
        $this->assertDebuggingCalled();
        $this->assertEquals('Fake full featured plugin / [[subplugintype_fulldeletedsubtype_plural]]', $pluginman->plugintype_name_plural('fulldeletedsubtype'));
        $this->assertDebuggingCalled();
    }
}
