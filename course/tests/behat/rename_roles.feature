...
Feature: Rename roles within a course
  ...
  Scenario: Rename roles within a course
    ...
    And I should see "Role: Tutor (Non-editing teacher)" in the ".form-autocomplete-suggestions" "css_element"
    And I should see "Role: Learner (Student)" in the ".form-autocomplete-suggestions" "css_element"
