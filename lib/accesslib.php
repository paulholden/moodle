...
abstract class context extends stdClass implements IteratorAggregate {
    ...
    */
     ...
     * @return array
     */
    public abstract function get_capabilities(string $sort = 'contextlevel,component,name');
...
class context_helper extends context {
     ...
     * @param string $sort
     */
    public function get_capabilities(string $sort = 'contextlevel,component,name') {
    }
}
